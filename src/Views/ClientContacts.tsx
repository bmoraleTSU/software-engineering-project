  ...
  return (
    <>
            ...
            <section className="section">
                <nav className="navbar has-shadow is-fixed-top test-app-header" role="navigation" aria-label="main navigation">
                    <div className="navbar-brand">
                        ...
                        <img
                            src={require("../pageTitles/client_contacts_title.png")}
                            alt="Logo"
                            width="auto"
                            height="auto"
                        />
                                ...
                                <div className="field is-grouped">
                                    <p className="control">
                                        <a className="button is-success is-light" href="/" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
                                            <span className="icon">
                                                <i className={isHovering ? 'fas fa-duotone fa-address-book fa-bounce' : 'fas fa-duotone fa-address-book'}></i>
                                            </span>
                                            <span>
                                                Add Client Contact
                                            </span>
      ...
      <div className="hero-body">
        <h2>This is where the client contacts would go!</h2>
      </div>
    </>
  );
}
