  ...
  return (
    <>
            ...
            <section className="section">
                <nav className="navbar has-shadow is-fixed-top test-app-header" role="navigation" aria-label="main navigation">
                    <div className="navbar-brand">
                        ...
                        <img
                            src={require("../pageTitles/accesslogs_title.png")}
                            alt="Logo"
                            width="auto"
                            height="auto"
                        />
                                ...
                                <div className="field is-grouped">
                                    <p className="control">
                                        <a className="button is-success is-light" href="/" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
                                            <span className="icon">
                                                <i className={isHovering ? 'fas fa-duotone fa-house-user fa-bounce' : 'fas fa-duotone fa-house-user'}></i>
                                            </span>
                                            <span>
                                                Return Home
                                            </span>
      ...
      <div className="hero-body">
        <h2>This is where the access logs would go!</h2>
      </div>
    </>
  );
}
